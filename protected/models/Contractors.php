...
class Contractors extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('IsJoinNetwork, IsFreeMypage', 'numerical', 'integerOnly'=>true),
			...
			array('Email, Website', 'length', 'max'=>200),
			array('AboutBusiness, Services', 'length', 'max'=>800),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ContractorId, Name, ContactName, Phone, Fax, Address1, Address2, City, State, Zip, Email, Website, AboutBusiness, Services, IsJoinNetwork, IsFreeMypage, Created', 'safe', 'on'=>'search'),
		);
	}
